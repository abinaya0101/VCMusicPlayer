...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton("🔥 Fork 🔥", url='https://t.me/bcddgblg'),
    ],
    [
        InlineKeyboardButton('👥 Group Sementara tidak di aktifkan'),
        InlineKeyboardButton('Channel Sementara tidak di aktifkan'),
    ],
    [
...
async def show_help(client, message):
    buttons = [
        [
            InlineKeyboardButton("🔥 Source Code 🔥", url='https://t.me/bcddgblg'),
        ],
        [
            InlineKeyboardButton('👥 Group Sementara tidak di aktifkan'),
            InlineKeyboardButton('Channel Sementara tidak di aktifkan'),
        ...
        [
            InlineKeyboardButton('🔰 Deploy 🔰', url='https://t.me/bcddgblg'),
